/**
 * Loads the bundled servo_catalog.json and exposes helpers to look up a
 * model from the raw 8-byte model id bytes at config offset 0x40..0x47.
 *
 * This module is transport-agnostic and should be shared across CLI,
 * desktop, and future browser surfaces.
 */
